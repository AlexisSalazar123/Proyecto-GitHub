...
if(isset($_GET['txtID'])){ //Si se paso id como parámetro get
    ...
    $ins = $con->query("SELECT COUNT(*) as TotalRe FROM inventario WHERE nombre_proveedor = '$id'");
    ...
    if ($clientes_asociados > 0) {
        ...
        echo '<script>
            Swal.fire({
                ...
                text: "El proveedor está asociado en el inventario",
    ...
    $query = $con->query("SELECT foto FROM proveedor WHERE id_proveedor = '$id'");
    ...
    $del = $con->query("DELETE FROM proveedor WHERE id_proveedor=".$id);
        ...
        <table class="table table-striped table-hover table-bordered" id="tabla_id">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="table-dark">Razon social</th>
            ...
            <?php 
            $sel = $con->query("SELECT * FROM proveedor");
            ...
            ?>
                ...
                <td>
                    ...
                    | <a class="btn btn-danger" href="javascript:borrar(<?php echo $fila['id_proveedor'];?>);" role="button">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="exampleModalLabel">Editar Proveedor</h1>
            ...
            <div class="modal-body">
                <form action="update.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nombrePr" name="nombrePr" class="form-control" required>
                        <img class="input-icon" id="icons2" src="../img/Icons/user2.svg" alt=""> 
                    </div>
                    <div class="mb-3">
                        <label for="" class="col-form-label">Razón Social:</label>
                        <input type="text" id="razon" name="razon" class="form-control" required>
                        <img class="input-icon" id="icons3" src="../img/Icons/razon.svg" alt=""> 
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" style="" name="imagen" id="imagen">
                        <img class="input-icon" id="icons4" src="../img/Icons/photo.svg" alt="">
                        <div class="text-danger"></div>
                    </div>
                    <div class="mb-3">
                        <label for="direccion2" class="col-form-label">Dirección:</label>
                        <img class="icon2" id="icons5" src="../img/Icons/direction.svg" alt="">
                        <input type="text" id="direccion2" name="direccion2" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="col-form-label">Teléfono:</label>
                        <img class="icon2" id="icons6" src="../img/Icons/telefono.svg" alt="">
                        <input type="number" id="telefono2" name="telefono2" class="form-control" required>
                    </div>
                    <div class="mb-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
            <input type="text" id="nombreP" name="nombreP" class="form-control" placeholder="Ingrese el Nombre" required>
            <img class="input-icon" id="img1" src="../img/Icons/user2.svg" alt="">
          </div>
          <div class="mb-3">
            <input type="text" id="razonS" name="razonS" class="form-control" placeholder="Ingrese la Razon Social" required>
            <img class="input-icon" id="img2" src="../img/Icons/razon.svg" alt="">
          </div>
          <div class="mb-3">
            <input type="file" class="form-control" style="" name="imagen" id="imagen" required>
            <img class="input-icon" id="img3" src="../img/Icons/photo.svg" alt="">
            <div class="text-danger"></div>
          </div> 
          <div class="mb-3">
            <input type="text" id="direccion" name="direccion" class="form-control" placeholder="Ingrese la Dirección" required>
            <img class="input-icon" id="img4" src="../img/Icons/direction.svg" alt="">
          </div>
          <div class="mb-3">
            <input type="number" class="form-control" id="telefono" name="telefono" placeholder="Ingrese el Teléfono" required>
            <img class="input-icon" id="img5" src="../img/Icons/telefono.svg" alt="">
          </div>
          <div class="mb-3">
...
<script>
    ...
    $('.editbtn').on('click', function(){
        ...
        $('#numero').val(datos[0]);
        $('#nombrePr').val(datos[2]);
        $('#razon').val(datos[3]);
        $('#imagen_previa').attr('src', imagenURL);
        $('#direccion2').val(datos[4]);
